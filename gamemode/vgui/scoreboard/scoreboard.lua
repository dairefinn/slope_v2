if CLIENT then
    ...
    -- Scoreboard columns
	local 	Columns = {
        [1] = {name="Name", command=function(self, arg) return tostring(arg:Name()) end},
        [2] = {name="Team", command=function(self, arg) return tostring(team.GetName(arg:Team())) end},
        [3] = {name="Ping", command=function(self, arg) return tostring(arg:Ping()) end},
    }
